...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    meta: {
      modules: 'angular.module("dd.common", [<%= srcModules %>]);',
      tplmodules: 'angular.module("dd.common.tpls", [<%= tplModules %>]);',
      all: 'angular.module("dd.common", ["dd.common.tpls", <%= srcModules %>]);',
      banner: ['/*',
               ' * <%= pkg.name %>',
               ' * <%= pkg.homepage %>\n',
  ...
  function findModule(name) {
    ...
    var module = {
      name: name,
      moduleName: enquote('dd.common.' + name),
  ...
  function dependenciesForModule(name) {
    ...
    .forEach(function(contents) {
      ...
      dependencies.split(',').forEach(function(dep) {
        if (dep.indexOf('dd.common.') > -1) {
          var depName = dep.trim().replace('dd.common.','').replace(/['"]/g,'');
